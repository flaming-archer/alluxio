...
var hadoopDistributions = map[string]version{
	...
	"hadoop-2.10": parseVersion("2.10.sdi-059"),
	...
	"default": parseVersion("2.10.sdi-059"),
}
...
var ufsModules = map[string]module{
	...
	"ufs-hadoop-ozone-1.2.1": {"hadoop-ozone-1.2.1", "ozone", true, "-pl underfs/ozone -Pufs-hadoop-2 -Dufs.ozone.version=1.2.1"},
}
